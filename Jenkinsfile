pipeline {
    ...
    environment{
        NETLIFY_SITE_ID = 'df7114ae-8f76-4626-ae65-a38f54f1576a'
    ...
    stages {
        stage('AWS'){
            ...
            environment{
                AWS_S3_BUCKET = 'learn-jenkins-202521121858'
            }
        ...
        stage('Deploy prod') {
            ...
            environment{
                CI_ENVIRONMENT_URL = 'https://extraordinary-chimera-358753.netlify.app'
            }
